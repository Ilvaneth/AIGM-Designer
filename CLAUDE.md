...
- **Status:** slices 0 and 1a delivered 2026-09-24 (plan 24.3), the fixture bible renamed to `.claude/skills/dnd/tests/fixtures/salt-lantern/` on 2026-09-25; slice 1b (the `data/design/*.yaml` tables, item 17) is in progress and the user reads each batch before the next; the schemas live in `docs/schemas/`.
