...
- **In-world date/time:** Ember Court içinde — "Zaman garip akıyor" (`ember-court.md`), dış dünyayla tam senkron değil. Kesh Amara'dan giriş gün 202/203 gecesi (Restday) oldu, içeride geçen süre belirsiz/esnek tutulmalı.
...
**Zorluk kalibrasyonu**
- **★ Combat Difficulty Doctrine — `reference/combat-difficulty-doctrine.md`** (v1 2026-09-10 → v2/v3 2026-09-17). Her boss/önemli encounter kurulurken bu dosya açılıp kontrol edilir: çok-round HP hesabı, varsayılan direnç profili, terrain koruması, boss öncesi kaynak tüketimi, gerçek HP/AC taşıyan destek yaratıklar, ve düşman itemizasyonu (imza silah + direnç item'ı, destek yaratıklar sıfır loot). Rastgele/doku encounterlar hafif kalabilir.
