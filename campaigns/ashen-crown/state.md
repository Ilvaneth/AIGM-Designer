...
## Current Situation
- **★★★★★★★★ GÜNCEL (session 37, 2026-09-23) — Location:** **The Ember Court** (Kaal hanesinin sınır düzlemi, `reference/ember-court.md`). **DUNGEON TAMAMEN TEMİZLENDİ (24/24 oda) — İSKRA VANTREL VE SATHRIEL KALICI OLARAK ÖLDÜ (Oda 24, Kor Beşiği, gün 204 öğleden sonra).** Final boss (Rakshasa Rajah + Pit Fiend) yenildi — Kriv 4 HP'ye kadar düştü, İlvaneth'in Wish'i (güvenli etki, bedelsiz) kurtardı. Efreeti Bottle ilk kez açıldı, 1 saat yardım etti. Whisper Court'un "Survive the Ember Court" operasyonu terk edildi (`factions.py`). **Rest hâlâ alınmadı — parti hâlâ Ember Court içinde, dışarı çıkış/Kesh Amara'ya dönüş bekleniyor.**
- **Arkaplan:** Üç hane yemeğinden sonra (Corr/Sablewood/Ilvane, gün 201) parti "Kesh Amara" sözleşme evini (Kingsward Dış Mahalle) buldu — D.V./Elian Rook üzerinden sızdılar (**Cinderday gecesi, 37 Ashfall / gün 203**, imp-muhafızın hafızası silinerek). O geceki toplantıda Iskra, **Sathriel**, bir yazman-imp, ve **Ostwin Kade** (Veskin'in kâtibi) ile karşılaştılar — imp ve Kade öldü, Iskra/Sathriel ağır yaralı Ember Court'a çekildi. Parti peşlerinden geçti, 24 odayı tek oturumda (session 36-37) temizledi, **Oda 24'te ikisini de kalıcı olarak yok etti.** Whisper Court'un otuz yıllık gizli ağı artık liderliksiz.
- **In-world date:** Hollowday, 39 Ashfall 1188 — sabah (08:00)  [Gün 205] · **Emberhold, Sonnward Promenade konağı.** Long rest tamamlandı.
  - **★ Düzeltilen script hatası (2026-09-23):** `calendar.py set` komutu tarihi değiştirirken `day_counter` alanını yeniden hesaplamıyor — 39 Ashfall'a geçildiğinde sayaç yanlışlıkla 204'te kalmıştı (38 Ashfall'ın değeri). `calendar.json`'da elle 205'e düzeltildi, `calendar.py check` artık tutarlı. İleride `calendar.py set` her kullanıldığında bu kontrol edilmeli — script'in kendisi düzeltilene kadar.
...
- **Party:** Ilvaneth Duskmere — High Elf Necromancy Wizard **18** | HP 123/123 | AC **19** | XP **284.642** | Neutral Evil | Proficiency +6 | Tüm spell slotları dolu (5. seviye artık 3) | Spell Mastery: Mage Armor+Invisibility slotsuz | Inspiration ✓ | **Ascension Stage 4 aktif** || Kriv Shestendeliath — Red Dragonborn Battle Master Fighter **18** | HP 205/205 | AC **22** | XP **284.642** | Neutral Evil | Proficiency +6 | Action Surge 2/2, Second Wind 1/1, Indomitable 3/3, Hit Dice 18/18, Superiority Dice 6/6 (artık d12), Legendary Resistance 1/1 | Inspiration ✓ | **Ascension Stage 4 aktif (uçuş 60ft, 9d6 nefes/40ft koni, Truesight 60ft, Legendary Resistance 1/gün)**
