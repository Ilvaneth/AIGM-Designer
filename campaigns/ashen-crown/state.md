...
- **In-world date:** Hollowday, 39 Ashfall 1188 — akşam (19:20)  [Gün 205] · **Emberhold, Sonnward Promenade konağı (Mordenkainen's Magnificent Mansion içinde, Ilvaneth'in konsantrasyonu 24 saate kadar sürebilir).**
...
## Active Quests
- **★★★★★★★★ TAMAMEN ÇÖZÜLDÜ (gün 204, session 37) — Ember Court, Iskra Vantrel ve Sathriel.** 24 odalık dungeon tamamen temizlendi, her ikisi de Kor Beşiği'nde kalıcı olarak infaz edildi. Bu ipliğin doğrudan devamı olarak açılan yeni, henüz çözülmemiş ipler: (1) **"Marek Vantrel"** — Whisper Court'un gerçek üst-otoritesi, DM-only, sadece İlvaneth'in Ascension rüyasından biliniyor, oyunculara henüz açıklanmadı. (2) **Kendini güncelleyen borç defteri** — Kaal'a borçlu ölümlü ailelerin kaydı, artık geçersiz sözleşmeler ama gerçek bir siyasi kaldıraç (kimin kime, ne kadar borçlu olduğu), henüz incelenip kullanılmadı. (3) **Sözleşme Taşı'nın son parçaları** — artık tamamen onarılabilir durumda (Oda 5 + Oda 24 parçaları birleşince), henüz onarılmadı, ne işe yarayacağı (başka bir sözleşmeyi iptal etmek?) henüz keşfedilmedi. (4) **Hapsedilmiş kül-ruhu** (demir kasada) — İlvaneth yanında taşıyor, serbest bırakılmadı, kaderi kararlaştırılmadı. (5) **Üç hanenin (Corr/Sablewood/Ilvane) Whisper Court'un gerçek doğasını öğrenmesi** — `factions.py` gün 210-211'de gerçekleşeceğini söylüyor, parti henüz kimseye anlatmadı.
...
**Güncel Krallık Hazinesi bakiyesi: ~2.000-2.500 (eski) + 47.000 (Veskin itirafı) - 17.500 (saray tadilatı, gün 208, session 38, Persuasion nat20 ile 25.000'den pazarlıkla) = ~31.500-32.000 gp**, artı aylık ~15.750 gp net gelir.
