...
**Created:** 2026-08-23 (migrated to this structure 2026-09-06)  **Last session:** 2026-09-22 (Session 36, hâlâ açık)  **Session count:** 36  **Ruleset:** 2014
...
- **In-world date:** Duskday, 38 Ashfall 1188 — early morning (02:00)  [Gün 204]  ·  **The Ember Court**'ta (oran x1, içeride geçen: 4s)
  ...
  - **Düzlem zamanı:** Ember Court'a giriş Gün 203, 22:00 (Cinderday gecesi). İçeride 4 saat geçti (session 36'nın Oda 1-11'i — tahmini, oynanırken `calendar.py scene ...` ile netleşecek). **Oran şu an x1 (yer değiştirmiyor); `ember-court.md` "zaman garip akıyor" diyor — gerçek oranı belirleyince `calendar.py -c ashen-crown plane rate --rate N` ile ayarla.**
  - **⚠ Çözülmemiş tutarsızlık:** Kesh Amara sızması düzyazıda "Restday gecesi" olarak geçiyor, ama takvim aritmetiğinde Ashfall'ın Restday'leri 7/14/21/28/35/42. Gün 203 = 37 Ashfall = Cinderday. Ya sızma Gün 201 (35 Ashfall, Restday) idi, ya da "Restday" etiketi yanlış yazıldı. Gün sayacı (203) son save'den geldiği için kanonik kabul edildi; hangisinin düzeltileceği oyuncunun kararına bırakıldı.
- **Party:** Ilvaneth Duskmere — High Elf Necromancy Wizard **17** | HP 114/116 | AC **19** | XP **261.257** | Neutral Evil | Proficiency +6 | **9. seviye slot açıldı (True Polymorph, Power Word Kill kullanılabilir)** | Inspiration ✓ | **Ascension Stage 4 aktif (session 36 yüklemesinde işlendi — level 17 + 8/9 fragman eşiği session 35 sonunda zaten sağlanmıştı, gözden kaçmıştı; bu tetikleyici rest/lokasyon düzeltmesinden bağımsız, geçerliliğini koruyor)** || Kriv Shestendeliath — Red Dragonborn Battle Master Fighter **17** | HP 177/196 | AC **22** | XP **261.257** | Neutral Evil | Proficiency +6 | Action Surge 2/2, Indomitable 3/3 | Inspiration ✓ | **Ascension Stage 4 aktif (uçuş 60ft, 9d6 nefes/40ft koni, Truesight 60ft, Legendary Resistance 1/gün — session 36 yüklemesinde işlendi)** — **★ Level 17'ye Ember Court içinde, Oda 1-2'nin XP'siyle, Long Rest beklenmeden işlendi (oyuncu talebiyle, gün 203, session 35) — Level 18 eşiği 265.000.**
...
## Faction Moves
*Şu an işleyen "saatler" — parti meşgulken dünya hareket ediyor.*
...
- **Kesh Amara sızması (Kingsward Dış Mahalle):** D.V./Elian Rook üzerinden ulaşılan "Kaal" sözleşme evine Restday gecesi girildi, imp-muhafızın hafızası Modify Memory ile silindi. Restday toplantısında Iskra Vantrel, kıdemli rakshasa yoldaşı Sathriel, bir yazman-imp, ve Ostwin Kade (Veskin'in gönüllü kâtibi) ile karşılaşıldı.
...
## Session Flags
- **session_status: open** (2026-09-21, `/dm:dnd load` ile session 36 başladı.)
...
- **next_session_opening (2026-09-17 güncellendi, session 31 sonunda):** Parti, Kule-i Mensuh'un en derin odasında (The Undying Study), tam loot toplanmış, dungeon tamamen temizlenmiş halde. **İlk iş: uzun mola + pending level-up'ları işlemek (Level 14, 162.437 XP — 24 saat kuralı kontrol edilmeli, gün 186 sabahından beri geçen süreye bakılmalı).** Açık kararlar: House Ashveil'daki tuzaktan yakalanan 2 House Ilvane ajanı + Elian Rook ifşası nasıl kullanılacak; Sylandra Cael'e kendi geçmişi hakkındaki sezgiyi (Oda 17 notları) açıp açmayacakları; Sundered Reach'teki son 2 Crown parçası (Ivrathax, Ser Oskar Thrune) hâlâ bekliyor; Sarelle henüz Vayle/Reyna Sorrel kaybını fark etmedi. **Bang önerisi:** dungeon'dan çıkışta (Kule-i Mensuh'un yüzeyi Ash Reeve'e açılıyor) Sylandra Cael'in kendisi karşılarına çıkıp alt katlara indiklerini fark etmiş olabilir — doğrudan bir yüzleşme fırsatı, ama Standard 10 gereği zorlanmamalı.
