...
**Created:** 2026-08-23 (migrated to this structure 2026-09-06)  **Last session:** 2026-09-23  **Session count:** 39  **Ruleset:** 2014

## Current Situation
- **★★★★★★★★★ GÜNCEL (session 38, 2026-09-23) — KRİV KRAL İLAN EDİLDİ, İKİ YILLIK TAHT BOŞLUĞU BİTTİ.** Location: **Emberhold, Sonnward Promenade konağı** — Ilvaneth'in Mordenkainen's Magnificent Mansion'ı içinde (bkz. `reference/ilvaneths-mansion.md`), tam gizlilik altında. Kriv, Sereth Corr + Berengar Sablewood + Cassian Ilvane + Regent-Chancellor Maro Veskin'i akşam yemeğine çağırdı; Kaal'ın borç defterini (Ember Court, Oda 5/24 loot'u) yüksek sesle okuyup Whisper Court'un gerçek doğasını (Kaal hanesi, rakshasa) VE Iskra Vantrel/Sathriel'in kalıcı ölümünü ilk kez üç haneye + Veskin'e açıkladı — ardından kendini Kral ilan etti (sadece bir "koltuk" değil). Dördü de kabul etti, her biri kendi şartıyla: **Sereth/House Corr** — üç hane arasında resmen ilk sırada tanınacak (Veskin'in mührüyle), Dorren Corr'un adı Konsey kayıtlarına resmen geçecek; **Berengar/House Sablewood** — ticaret/kontratlar aynen sürüyor, artık Kral'a tribute; **Cassian/House Ilvane** — hanesi artık açıkça, gizli bir el olmadan Kriv'e bağlı; **Veskin** — ilanı resmi hale getirmeyi (mühür, tanık, kayıt) bizzat üstlendi, karşılığında kendi 20 yıllık usulsüzlüklerinin (artık Kriv'in elinde somut kanıt) örtülü kalması bekleniyor — söylenmedi ama ima edildi, gerçek bir kaldıraç. **Goal Tracker: Sereth ACHIEVED (session 38), Veskin PERMANENT_LOSS (session 38) — ikisi de scripts/goals.py'de işlendi.**
- **Arkaplan:** Üç hane yemeğinden sonra (Corr/Sablewood/Ilvane, gün 201) parti "Kesh Amara" sözleşme evini (Kingsward Dış Mahalle) buldu — D.V./Elian Rook üzerinden sızdılar (**Cinderday gecesi, 37 Ashfall / gün 203**, imp-muhafızın hafızası silinerek). O geceki toplantıda Iskra, **Sathriel**, bir yazman-imp, ve **Ostwin Kade** (Veskin'in kâtibi) ile karşılaştılar — imp ve Kade öldü, Iskra/Sathriel ağır yaralı Ember Court'a çekildi. Parti peşlerinden geçti, 24 odayı tek oturumda (session 36-37) temizledi, **Oda 24'te ikisini de kalıcı olarak yok etti.** Whisper Court'un otuz yıllık gizli ağı artık liderliksiz — ve artık, gün 205 akşamı itibariyle, bu gerçek dört büyük siyasi oyuncuya da açıklandı.
- **In-world date:** Warday, 12 Cinderwake 1188 — öğleden sonra (16:30)  [Gün 223] · **Emberhold, The Ember Throne — taç giyme şöleni bitti, Krallık artık tam kurulu.**
  ...
  - **✓ Çözüldü (2026-09-22, session 36 `/dm:dnd end`, oyuncu kararı):** gün sayacı kanonik — **gün 203 = 37 Ashfall = Cinderday.** Sarelle'in Ashvale'deki zayıf saati ayrı ve doğru bir olgudur — o gerçekten Restday geceleridir, değiştirilmedi.
- **Party:** Ilvaneth Duskmere — High Elf Necromancy Wizard **18** | HP 141/141 (Manual of Bodily Health tamamlandı, CON +2, +18 HP dahil — karakter sayfasıyla doğrulandı, session 39) | AC **21** (Staff of Power dahil) | XP **290.942** | Neutral Evil | Proficiency +6 | Spell Attack +12/Spell Save DC 18 | Inspiration ✓ | **Ascension Stage 4 aktif** || Kriv Shestendeliath — Red Dragonborn Battle Master Fighter **18** | HP 205/205 | AC **22** | XP **290.942** | Neutral Evil | Proficiency +6 | STR 29 (Belt of Storm Giant Strength) | Action Surge 2/2, Second Wind 1/1, Indomitable 3/3, Hit Dice 18/18, Superiority Dice 6/6 d12, Legendary Resistance 1/1 | Inspiration ✓ | **Ascension Stage 4 aktif (uçuş 60ft, 9d6 nefes/40ft koni, Truesight 60ft, Legendary Resistance 1/gün)**
- **Party status (2026-09-23 güncellendi, session 38):** **Wren Marrow himayede.** Sunken Ledger yok edildi. **Kriv artık Emberhold'un Kralı — üç hane (Corr/Sablewood/Ilvane) + Regent-Chancellor Veskin resmen tanıdı (gün 205 akşamı).** Sereth hâlâ mesafeli ama artık gerçek bir müttefik (First Among Houses şartıyla), Berengar transaksiyonel/memnun, Cassian gerçek bir bağlı-müttefik. **Iskra Vantrel ve Sathriel kalıcı öldü (gün 204) — bu artık dört büyük NPC'nin de bildiği bir gerçek (gün 205 akşamı açıklandı), ama halka/kamuya henüz duyurulmadı.** **Ostwin Kade (Veskin'in kâtibi) öldü.** **Aşkalkanı/"Bayan V." ipliği** (Karsgate/House Corvane, 17 yıl önce) hâlâ çözülmedi. **Coren Ashvale ile gizli darbe planı** sürüyor. **Tain'in Concordat devri sürüyor.** Goal Tracker: **Sereth ACHIEVED, Veskin PERMANENT_LOSS, Whisper Court PERMANENT_LOSS (session 37), Sarelle PERMANENT_LOSS.** Sylandra Cael ile tam ortaklık sürüyor. Ser Aldwin Ashvale (ghost) ile ittifak. **Tobin Wrey hâlâ düşman, henüz haberi yok.** **Satılmamış Ember Court loot: Kaal'ın Zulüm Bıçakları, İblis Topuzu, Kaal Muhafızının Bileziği.**
...
## Active Quests
- **★★★★★★★★★ YENİ (gün 221, session 38) — "Ashen Corwyn," kukuletalı bir gözlemci, taç giyme şöleninde belirdi.** Iskra Vantrel'in gerçekten kalıcı öldüğünü doğrulamaya geldi ("bazı insanlar bunu duymak ister"), kaynağını açıklamadan ayrıldı — sol elinin küçük parmağında kırık-daire motifli gümüş bir yüzük vardı, Kaal'ın mührüyle aynı. Kriv, kanıt isteyen herkese bedavaya göstereceğini ama bir şartı olduğunu söyledi (şart henüz açıklanmadı, sadece gelenlere söylenecek). **Muhtemelen "Marek Vantrel" ile bağlantılı — henüz doğrulanmadı, DM-only ipucu hâlâ geçerli.**
- **★★★★★★★★ TAMAMEN ÇÖZÜLDÜ (gün 204, session 37) — Ember Court, Iskra Vantrel ve Sathriel.** 24 odalık dungeon tamamen temizlendi, her ikisi de Kor Beşiği'nde kalıcı olarak infaz edildi. Bu ipliğin doğrudan devamı olarak açılan yeni, henüz çözülmemiş ipler: (1) **"Marek Vantrel"** — Whisper Court'un gerçek üst-otoritesi, DM-only, sadece İlvaneth'in Ascension rüyasından biliniyor, oyunculara henüz açıklanmadı — bkz. yukarıdaki "Ashen Corwyn" ipucu, muhtemelen bağlantılı. (2) **Kendini güncelleyen borç defteri** — Kaal'a borçlu ölümlü ailelerin kaydı artık **kullanıldı** (gün 205, üç hane + Veskin'e karşı, taht ilanının parçası olarak) — geriye kalan kısmı (diğer, isimsiz borçlular?) henüz incelenmedi. (3) **Sözleşme Taşı'nın son parçaları** — artık tamamen onarılabilir durumda, henüz onarılmadı, ne işe yarayacağı henüz keşfedilmedi. (4) **Hapsedilmiş kül-ruhu** (demir kasada) — İlvaneth yanında taşıyor, serbest bırakılmadı, kaderi kararlaştırılmadı. (5) **✓ ÇÖZÜLDÜ (gün 205, session 38) — üç hane (Corr/Sablewood/Ilvane) + Veskin, Whisper Court'un gerçek doğasını (Kaal, rakshasa) öğrendi**, Kaal'ın borç defterinin okunmasıyla — bu, Kriv'in Kral ilan edilmesinin doğrudan parçası oldu.
- **★★★★★★★★ YENİ, AÇIK (gün 205-221, session 38) — Kriv Kral ilan edildi, Krallık kuruldu.** Üç hane + Ironclad Compact + Kindled Circle bağlandı. Açık uçlar: **Hollow Throne'un kendisi** (parti fragmanları tanıdı ama tahta hiç oturmadı, "sonra karar verelim"); **Kırılmayan Öz ritüeli** (Ilvaneth tamamladı, hiç kullanılmadı — Sylandra Cael merak edip haber gönderecek, gün 230); **satılmamış Ember Court loot** (Kaal'ın Zulüm Bıçakları, İblis Topuzu, Kaal Muhafızının Bileziği); **Ilvane Aynası'nın güvenlik kontrolü** (saray kapısında, istisnasız, parti dahil).
...
## ★★★ Kral Payı — Krallık Hazinesi'nin resmi modeli (gün 206, session 38'de kuruldu, oyuncu kararıyla)

**Eski patchwork tablo (aşağıda, tarihsel referans) artık kullanılmıyor.** Kriv Kral ilan edildikten sonra, ayrı ayrı bölgesel/faction gelir kalemleri yerine tek bir model kabul edildi: **haritanın toplam ekonomisinin %10'u, doğrudan Krallık Hazinesi'ne akar — "Kral Payı."**

| Kalem | Aylık (gp) |
|---|---|
| Haritanın toplam ekonomisi (Gallowmere + Harrowgate + Shestendeliath Hold + Emberhold, ~120.000 nüfus + vassal bölgeler) | **~180.000** |
| **Kral Payı (%10)** | **~18.000** |
| Sabit gider — Teleportation Circle malzemesi (294 gün kaldı) | -2.250 |
| **NET — Krallık Hazinesi'ne** | **~15.750 gp/ay** |

Bu model; Ironclad Compact'ın %10 vergisini, üç hanenin (Corr/Sablewood/Ilvane) %10 tribute'unu, Harrowgate'in eski %10'unu, Karsgate Undertow anlaşmalarını, Darphane'yi, Gallowmere Hazinesi'ni — hepsini tek bir kapsamlı rakamın içine alıyor. Ayrı ayrı takip edilmiyor artık.

**★★★ Veskin'in itirafı (gün 208, session 38) — Krallık Hazinesi'ne büyük bir tek seferlik enjeksiyon.** Regent-Chancellor Maro Veskin, iki yıllık usulsüzlüğünü itiraf etti: gerçek toplanan vergi ~240.000 gp (2 yıl), ~168.000 gp gerçek idare/muhafız/bakım masrafına gitti, Veskin ~30.000 gp çaldı (12.000 gp'si hâlâ elinde, teslim edildi — Kriv'e), ve **~35.000 gp hiç dokunulmadan hazine kasasında bekliyordu** (iki yıldır gerçek bir Kral olmadığı için kimse talep etmemişti). Toplamda **+47.000 gp Krallık Hazinesi'ne** (12.000 Veskin'in kesesinden + 35.000 unutulmuş kasadan). Kriv, Veskin'i cezalandırmadı — açık bir uyarıyla görevde tuttu, sıkı gözetim altında.

**Güncel Krallık Hazinesi bakiyesi (gün 221 itibariyle): ~2.000-2.500 (eski) + 47.000 (Veskin itirafı) - 17.500 (saray tadilatı) + ~5.250 (gün 211-221 arası, 10 günlük Kral Payı tahakkuku) = ~36.750-37.250 gp**, artı aylık ~15.750 gp net gelir işlemeye devam ediyor.

**★ Netleştirme (gün 208, oyuncu sorusu) — Kral Payı, Kriv'in kişisel kesesi DEĞİL, Krallığın TEK bütçesi.** Ordu maaşı, saray personeli, bakım, ve büyük tek seferlik projeler (tadilat gibi) hepsi bu hazineden çıkar — ayrı bir "devlet bütçesi" yok, Kriv mutlak monark olarak tam tasarruf yetkisine sahip ama aynı pot hem gelir hem gider için kullanılıyor. Gerçekçi aylık giderler hesaplandı: 600 asker maaşı (~2 gp/asker/ay = -1.200 gp), saray personeli (12 kişi, ~-100 gp), genel bakım (~-300 gp), Teleportation Circle (-2.250 gp) = **toplam ~-3.850 gp/ay sabit gider.** Bu, %10'luk Kral Payı'nın (~18.000 gp/ay) yeterli olduğunu gösteriyor — tüm giderler çıktıktan sonra hâlâ **~14.150 gp/ay net kâr** kalıyor. %10 az değil, ordu/saray büyüdükçe yeniden değerlendirilebilir ama şu an için rahat bir marj var.

**Kişisel keseler (Krallık Hazinesi'nden tamamen ayrı):** Kriv ve Ilvaneth'in kendi cüzdanları — dungeon/combat loot, kişisel alışveriş buraya işlenmeye devam ediyor, Kral Payı'na dahil değil.

---

## ★★ Konsolide Hazine Tablosu (gün 154'te oluşturuldu, session 26 FF — aylık, 45 günlük ay bazında) — ★ ARTIK GEÇERSİZ, tarihsel referans, yukarıdaki Kral Payı modeline bakın
...
- **★★★★★★★★ EN YENİ, EN BÜYÜK (gün 204, session 37) — Iskra Vantrel ve Sathriel Kor Beşiği'nde KALICI OLARAK ÖLDÜ, Whisper Court'un otuz yıllık operasyonu bitti.** Rakshasa Rajah + Pit Fiend muhafızları yenildikten sonra parti Beşiğe ulaştı, reform tamamlanmadan ikisini de infaz etti. Whisper Court liderliksiz — `factions.py react` sonucuna göre Cassian Ilvane (House Ilvane), Sereth Corr (House Corr), Berengar Sablewood (House Sablewood), Coren Ashvale (Ironclad Compact), Odalys Ferrant (Kindled Circle), Doss/Sella Dray (Undertow), D.V. hepsi gün 210-211'de öğrenecek — henüz kimseye açıklanmadı. **İlvaneth'in bir Ascension rüyası, İskra'nın kendisinin bile Whisper Court'un gerçek tepesini bilmediğini ("sen sadece bir eldivensin... eldiven yırtılırsa, el başka bir eldiven bulur", bir isim/unvan: "Marek Vantrel") gösterdi — DM-only, ağın gerçek üst-otoritesi hâlâ bilinmiyor.**
- **★★★ AÇIK (gün 203'ten itibaren, session 35) — Parti fiziksel olarak başka bir düzlemdeyken (Ember Court, artık dönüldü) Emberhold'daki siyasi momentum kendi başına ilerledi.** Cassian kendi hanesini temizliyor; Sereth soğuk ama sadık bir ittifakta bekliyor; Berengar kâr peşinde sakin; Coren'in darbe hazırlığı (Ilse Drummel'in izlemesiyle) devam ediyor; Maro Veskin kâtibi Ostwin Kade'nin kaybolduğunu henüz fark etmedi. Parti şimdi döndü — bu ipliklerin ne kadar ilerlediği bir sonraki sahnede netleşmeli.
- **Tarihsel (gün 198, session 35, artık geçmişte kaldı) — Whisper Court'un gizliliği ilk kez ifşa oldu.** Iskra Vantrel/"V." kimliği açığa çıktı (House Ilvane'in kendi danışmanı, 20 yıldır), 8 aylık bir doppelganger (Corwen kılığında) yakalanıp öldürüldü. **Cassian Ilvane artık gerçek bir müttefik** — kendi hanesini baştan aşağı temizliyor, parti üç hanenin de sırlarını (Corr/Sablewood/Ilvane) elinde tutuyor.
...
## Active Combat
*(none — Oda 24 FİNAL BOSS temizlendi, session 37. Rakshasa Rajah + Pit Fiend öldürüldü — Kriv Pit Fiend'i tek başına bitirdi (Action Surge nova), Rajah'ı da (Trip Attack ile prone, sonra nova) neredeyse tek başına düşürdü, son darbe İlvaneth'in Draconic Transformation nefesiyle geldi. Kriv 4 HP'ye kadar düştü, İlvaneth'in Wish'i (güvenli "tam HP" etkisi, stres yok) onu kurtardı — 9. seviye slot bu yüzden harcandı. Efreeti (İlvaneth'in emrindeki, 1 saatlik) yardımcı oldu. Kor Beşiği artık parti kontrolünde — İskra ve Sathriel hâlâ yarı-biçimlenmiş, savunmasız halde bekliyor. +23.500 XP/kişi (Rajah CR19 + Pit Fiend CR20) — ikisi de 308.142 XP, LEVEL UP PENDING (18) hâlâ geçerli. Kriv: Action Surge 0/2, Second Wind 1/2, Superiority Dice 3/6, Legendary Resistance 1/1, Indomitable 3/3 — hepsi bir sonraki Long Rest'te yenilenecek. İlvaneth: 9. seviye slot 0/1.)*

## Live State Flags
*Structured facts designed to survive context compaction.*

**★★★ Saray güvenlik kuralı (gün 221, session 38) — The Ember Throne'un girişinde Ilvane Aynası (doppelganger/illüzyon/polymorph tespit ediyor) zorunlu kontrol noktası.** İçeri girmek isteyen HERKES (istisnasız) önce nöbetçi eşliğinde aynaya bakmak zorunda; reddeden tutuklanır, direnen öldürülebilir — Kriv'in doğrudan emri. Bu, Whisper Court'un doppelganger sızma geçmişine (Wrenna, Arnholt, Corwen) doğrudan bir yanıt. Parti kendisi de (ve gelecekte tanışacağı herhangi bir NPC/müttefik de) bu kontrolden geçmek zorunda — otomatik muafiyet yok.

**★ Gün 222 sabahı, session 39 — Ashen Corwyn (ellili yaşlarında, gri bıyıklı, sol kaşında yara izi, kırık-daire yüzüklü, büyü bilmiyor; Ilvane Aynası'ndan temiz geçti, Kriv'in Truesight'ı da hiçbir yanılsama görmedi) sarayın kapısında Kriv'le konuştu.** Kriv şartı açıkladı: kendi gözüyle görmek isterse büyüyle tek yön bilet, dönüş kendisine kalır; "Kral'ın sözü" alternatifi de var. Corwyn sözü seçti, mühürlü tek satır istedi. **Kriv mührü reddetti: Iskra Vantrel'in kalıcı ölümünü şehrin her yerinden HALKA duyuracağını söyledi — bu, önceki "halka henüz duyurulmadı" durumunu değiştirir; Whisper Court kalıntıları ve House Ilvane bunu duyacak.** Corwyn kimin adına geldiğini hâlâ söylemedi ("söylersem adım mezar taşına yazılır"). Dünkü Ilvaneth'in önerdiği doğrulama yöntemi kayıtlı değil (save boşluğu).

**★ Gün 222 öğle, session 39 — Kriv+Ilvaneth Emberhold'dan Teleport (Very familiar → d100=7, "Similar Area") ile Umm-Halad yolu girişi yerine benzer bir yere düştü; Kriv uçarak gerçek girişi ~10 mil KB'da buldu (Perception 18). Kral Kriv en fazla 1 haftalığına ayrıldı (Kriv'in territory bedeli gün 229'da başlar). Coren (King's General) asayişi devraldı; Halden'in Sending Stone'u ona verildi (channels.py: stone-coren). Coren'in izcileri Corwyn'ı takip ediyor; Corwyn Ember Quarter'da bir çocuğa Cinder Bell'in arka kapısına kâğıt gönderdi, sonra atla kuzey yoluna çıktı — Vesper Lark (yarı-elf, eski Compact denetçisi) izi sürüyor, Coren'e raporlayacak. Iskra'nın ölümü halka duyuruldu (tellal, Kriv'in adıyla).** Yolda: donmuş Long Coin kampı (3 ceset, Tobin Wrey'in eski adamları, yarası yok — yolun sunağına bir şey bırakmadan uyuyup ölmüşler, alçak taş gibi bir uğultu duymuşlar); Kriv'in aldığı harita: Kahin'in Yolu → Kar Vaelth (taş adam yarım gün), Kar Vaelth'ten 3 gün doğu Kemikçilerin Salonu ("eşiği geçme, muhafız uyumaz"), imza T.W.; Speak with Dead: Tobin Wrey Kahin'in sözünü toplu satmak istiyordu, alıcı kül-gri mühürlü mektup gönderiyordu (adı bilinmiyor), "bizi ilk göndermedi, dönenler az". İlvaneth'in Stage 1 Speak with Dead'i (1/long rest) kullanıldı.
...
- **★★★★★★★★ Lady Iskra Vantrel — KALICI OLARAK ÖLDÜ (gün 204, session 37, Oda 24 — Kor Beşiği, The Ember Court).** Kesh Amara'da (gün 202/203) ağır yaralanıp reform sürecine girmişti; Rajah + Pit Fiend muhafızları yenildikten sonra parti Beşiğe ulaştı, Kriv reform tamamlanmadan onu (ve Sathriel'i) kılıçla infaz etti. **Bu kez gerçekten ve geri dönüşsüz.** Whisper Court'un liderliği boş — kalan üyeler (Wrenna, Steward Arnholt gibi ajanlar) artık başsız. House Ilvane/Corr/Sablewood henüz haberi yok (Whisper Court gün 210'da öğrenecek, `factions.py`). Kesh Amara'daki eski eşyaları (kırık daire + "K" madalyonu, mektuplar) zaten parti elinde.
- **★★★★★★★ Sathriel (kıdemli rakshasa, Iskra'nın yoldaşı) — KALICI OLARAK ÖLDÜ (gün 204, session 37, Oda 24 — Kor Beşiği).** Iskra ile aynı anda, aynı şekilde infaz edildi. Kaal Muhafızının Bileziği ve Sözleşme Taşı'nın son parçaları Oda 24'ten alındı (bkz. Recent Events loot listesi).
...
- **★★★ Wrenna (Sereth Corr'un nedimesi) — DOPPELGANGER, AÇIĞA ÇIKARILDI VE İNFAZ EDİLDİ (gün 179/180, session 28).** **Düzeltme (2026-09-23, session 38, oyuncu tespitiyle) — bu satır önceden yanlışlıkla "Sereth onu öldürmedi, çift ajan olarak tuttu" diye kayıtlıydı; bu hatalıydı, `session-log-archive.md`'nin session 28 kaydıyla (ve state.md'nin kendi Continuity Archive'ındaki "Wrenna infaz edildi" satırıyla, ~line 1005) çelişiyordu. Gerçek olay: Detect Thoughts'un derin sondası gerçeği açığa çıkardı (2 yıldır Lady Iskra Vantrel'e/House Ilvane'e rapor veren bir ajan, Rookery sızıntısının kaynağı bizzat oydu) — Wrenna kendi isteğiyle Sereth'e itiraf etti, Sereth affetmedi, sözünü tutup orada infaz etti.** Aynı zamanda House Sablewood'un kahyası **"Steward Arnholt"**'un da bir doppelganger olduğu öğrenildi (Wrenna'nın itirafı) — Arnholt kaçmaya çalıştı, Kriv yakaladı, **canlı** olarak Berengar'ın kendi sorgusuna teslim edildi (bkz. aşağıdaki satır — Arnholt'un o andan sonraki kaderi Berengar'ın elinde, campaign'de ayrıca takip edilmedi).
...
### Session 36 — 2026-09-22 — Ember Court dungeon crawl (Oda 3-11), Ascension Stage 4, gün 203
- **Yükleme düzeltmesi:** önceki save'in "dungeon atlanıp eve dönüldü" hatası düzeltildi — gerçekte sadece Oda 1-2 oynanmıştı, Iskra/Sathriel o an hâlâ reform halindeydi.
- **Ascension Stage 4 işlendi (her ikisi de)** — Kriv gerçek kanatlar kazandı (60ft uçuş, Warden's Oathplate'i yararak çıktı), İlvaneth necrotic/poison/disease/exhaustion tam bağışıklık + 24 saatte reform kazandı.
- **Ember Court Oda 3-11 temizlendi** — Ledger Salonu, Sözleşme Kasası (master Kaal borç kayıtları + kırık Sözleşme Taşı parçaları alındı), Besleme Salonu (2× Erinyes), Ceza Hücreleri, Gözetmenin Odası, Yargı Çukuru — Oda 12'nin eşiğinde durduruldu.
- **Rakshasa'ların Limited Magic Immunity'si ilk kez karşılaşıldı** — İlvaneth'in 6. seviye ve altı büyüleri işe yaramıyor, taktik ayarlandı.
- XP: +29.295/kişi. İkisi de 261.257 XP, Level 17.
...
- **"V." = Lady Iskra Vantrel olarak ifşa edildi** (Cassian Ilvane'in 20 yıllık danışmanı, aslında bir rakshasa) — kendi evindeki 8 aylık doppelganger (gerçek Corwen'in yerini almış) Dominate Monster ile sorgulanıp öldürüldü.
- **Kesh Amara (Kaal hanesinin sözleşme evi) bulundu ve baskın düzenlendi** — Cinderday gecesi (37 Ashfall, gün 203) sızıldı, üç şehrin (Karsgate/Harrowgate/Emberhold) tam borç kayıtları ele geçirildi.
- **Iskra Vantrel + Sathriel (Kaal'ın kıdemli üyesi) ağır yaralandı** — o an kalıcı ölmediler, rakshasa doğaları gereği Ember Court'a (Kaal'ın kendi düzlemi) çekilip Oda 24'te reform sürecine girdiler (session 37'de kalıcı olarak sonlandırıldı, bkz. güncel kayıtlar).
- **Level 17'ye geçildi (ikisi de, Long Rest beklenmeden)** — İlvaneth 9. seviye slot açıldı, Kriv Action Surge 2/2 + Indomitable 3/3.
- **Sereth Corr ilişkisi kalıcı olarak soğudu** ("borç ödeşmesi" seviyesine düştü) — Kriv'in ağabeyi Dorren'in ölümünü kaldıraç olarak kullanması sonrası.
...
## Session Flags
- **session_status: open** (2026-09-23, session 39 `/dm:dnd load` ile açıldı; session 38 `/dm:dnd end` ile kapatılmıştı.)
