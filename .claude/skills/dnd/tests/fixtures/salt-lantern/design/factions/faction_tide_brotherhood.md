---
entity: faction_tide_brotherhood
type: faction
secrecy: public
phase: P4
stamped: [archetype, objective]
mirror: design/dm-only/factions/faction_tide_brotherhood.md
---
...
- **Archetype:** `criminal` · **Founded:** Lantern söndükten sonra, gemiler azalınca ([[event_lantern_dimmed]]) · **Alignment range:** N–NE
...
- **Power:** 2 · **Intel:** 2 · **Reach:** kayalık kıyı, rıhtım geceleri, Broken Breakwater
- **Military:** `bandit` ×8, `bandit captain` ×2 ([[npc_draskun]], [[npc_kortan]]); üç kayık
- **Magical:** yok · **Economic:** enkaz, kaçak tuz, rehin kayıklar · **Territory:** [[site_tide_cave]], [[site_sunken_pier]]
- **Assets on the map:** [[site_tide_cave]], [[site_sunken_pier]], [[place_weary_gull]] (rehin yoluyla kontrol)
- **HQ:** [[site_tide_cave]]
...
- **Stances:**
  ...
  |---|---|---|
  | [[faction_reedmarch]] | −2 | muhafız iskeleyi basacak; Reeve manifestoyu sattı ama sonra korktu |
  | [[faction_court_of_mourners]] | 0 | görünürde ilgisiz |
...
- **Reaction doctrine:**
  ...
  | death | Kortan reis olur; Court bağlantısı kopar |
  | betrayal | İhanet edeni cezirde mağarada bırakır |
- **First operation:** **Crate Run** (`op_tide_1`) — objective: Vesper'in sandıklarını ve tuzunu Lanternside'dan çıkarmak
  | Step | Kind | Due day | Defender | Text |
  |---|---|---|---|---|
  | 1 | timed | 10 | — | Sandıklar Sunken Pier'den Tide Cave'e taşınır |
  | 2 | contested | 25 | [[faction_reedmarch]] | Liman muhafızına rüşvet; Tolvan'ın kayıkları alınır |
  | 3 | timed | 40 | — | Tuz Mourners' Hall'a teslim edilir |
  - **Abandon if:** `control(site_tide_cave) != faction_tide_brotherhood or alive(npc_draskun) == dead`
...
- **True belief vs cover:** Brotherhood enkaz taşıdığını söyler; asıl yük tuzdur ve tuzun kime gittiğini yalnızca Draskun bilir.
...
- **What it wants independent of the party, and what it will have done in 60 days:** Sandıkları ve tuzu çıkarmak; gün 10'da sandıklar mağarada, gün 25'te kayıklar onların, gün 40'ta tuz Court'ta, gün 60'ta mağara boşalır.
