...
def _resolve_campaign_root() -> Path:
    ...
    if env:
        # DND_CAMPAIGN_ROOT is the DATA root — campaigns live under
        # <root>/campaigns/<name>/, same convention as paths.py's
        # campaigns_dir(). Appending "campaigns" here is required.
